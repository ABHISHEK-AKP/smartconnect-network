export default function Hero() {
  return (
    <section
      className="bg-cover backdrop-blur-md bg-white/30 bg-center h-[85vh] flex items-center text-white overflow-hidden"
    ...
    >
      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 z-10">
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold leading-tight mb-6 drop-shadow-xl text-black dark:text-white">
